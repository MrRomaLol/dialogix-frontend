...
const ContentBack = styled.div`
  ...
  background-color: ${({backgroundColor}) => backgroundColor || 'rgba(61, 38, 84, 0.2)'};
...
const ContentContainer = ({children, className, backgroundColor}) => {
    return (
        <Container className={className}>
            <ContentBack backgroundColor={backgroundColor}>
                {children}
            </ContentBack>
            <ContentBorder/>
        </Container>
